...
[![Forked From vilhelmprytz/pterodactyl-installer](https://img.shields.io/discord/682342331206074373?label=&logo=discord&logoColor=ffffff&color=7389D8&labelColor=6A7EC2)]
...
A Script made to install pterodactyl without having to setup all things. PLEASE DO NOT ASK SUPPORT REGARDING THIS TO PTERODACTYL HELP COMMUNITY.
...
```bash
bash <(curl -s https://raw.githubusercontent.com/unknownpersonog/pteroscript/master/install.sh)
```
